(function ($) {
    ...
    $(function () {
        function about_toggle() {
            $(".about-toggle").hide();
            $(".about-toggle.home-arrow").hide();
        };
        function product_toggle() {
            $(".poducts-toggle").hide();
            $(".poducts-toggle.home-arrow").hide();
        };
        ...
        tggle.on("click", function (e) {
            ...
            if (val == "nav-products") {
                product++;
                if (product % 2 == 0) {
                    $(".poducts-toggle.home-arrow").show();
                    ...
                    $('.arrow-product').on({
                        mouseenter: function () {
                            $(this).find('.arrow-image').show();
                        },
                        mouseleave: function () {
                            $(this).find('.arrow-image').hide();
                        }
                    });
                }
            }
            ...
            if (val == "nav-resource") {
                ...
                if (resource % 2 == 0) {
                    $('#signup-section').addClass("margin-top-60");
                    $(".resource-toggle.home-arrow").show();
                    ...
                    $('#signup-section').removeClass("margin-top-60");
                    $(".content-section").slideUp(200);
                    $(".resource-toggle.home-arrow").hide();
                    resource = 1;
                    $('.arrow-resource').on({
                        mouseenter: function () {
                            $(this).find('.arrow-image').show();
            ...
            if (val == "nav-community") {
                ...
                if (community % 2 == 0) {
                    $('#signup-section').addClass("margin-top-60");
                    $(".community-toggle.home-arrow").show();
                    ...
                    $('#signup-section').removeClass("margin-top-60");
                    $(".content-section").slideUp(200);
                    $(".community-toggle.home-arrow").hide();
                    community = 1;
                    $('.arrow-community').on({
                        mouseenter: function () {
                            $(this).find('.arrow-image').show();
